...
class OrderFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        btnConfirm = wx.Button(panel, id = wx.ID_ANY, label = "confirm", name = "confirm", size = wx.Size(btnWidth, btnHeight), pos = ( 100, 100))
        btnConfirm.SetFont(wx.Font(20, wx.SWISS, wx.NORMAL, wx.BOLD))
        btnConfirm.Bind(wx.EVT_BUTTON,self.OnClickedConfirmButton)
        btnConfirm.Disable()
